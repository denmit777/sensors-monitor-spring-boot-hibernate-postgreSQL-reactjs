package com.training.sensors_monitor.security.config.jwt;

import com.training.sensors_monitor.exception.JwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    public String createToken(final String login, final Role role) {
